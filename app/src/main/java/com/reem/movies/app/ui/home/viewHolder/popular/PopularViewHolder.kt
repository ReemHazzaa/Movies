package com.reem.movies.app.ui.home.viewHolder.popular
...
class PopularViewHolder (val binding: ViewDataBinding, onItemClickCallback: OnItemClickCallback) :
    ...
    override fun draw(listable: Listable) {
        super.draw(listable)
        val current = listable as PopularUiItem
    }
}